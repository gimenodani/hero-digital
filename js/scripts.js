...
function validateForm() {
    ...
    //validate inputs
    let name = document.forms["digitalForm"]["firstName"].value;
    let lastname = document.forms["digitalForm"]["lastName"].value;
    let email = document.forms["digitalForm"]["email"].value;
    ...
    //check At least one option needs to be selected
